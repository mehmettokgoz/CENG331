...
#
# To speed up my absrev.ys code, I implemented leaq in here.
#
# I used same process with sequential while implementing leaq.
# The difference is we are using temporary places to represent our values.
# 
# First, it fetchs all the rA, rB and valC.
# Then decodes what rB keeps.
# At the execute stage, it adds E_rB and E_valC
# Then it places value to d_destE which is D_rA
#
####################################################################
#/* $begin pipe-all-hcl */
####################################################################
